...
static const u8 sText_Legendary_Abilities[] = _("HAB. DELS LLEGEN.");
static const u8 sText_New_Legendaries[]     = _("{COLOR 3}{SHADOW 3}LLEGEN. EXTRA");
...
static const u8 sText_Unlimited_WT[]        = _("{COLOR 3}{SHADOW 3}I.F. IL·LIMITATS");
static const u8 sText_FrontierBans[]        = _("BAND. AL FRONT");
static const u8 sText_Shiny_Colors[]        = _("COLORS {PKMN} BRILL.");
...
static const u8 sText_Starter[] =                   _("{PKMN} INICIAL");
static const u8 sText_WildPkmn[] =                  _("{PKMN} SALVATGES");
static const u8 sText_Trainer[] =                   _("ENTRENADORS");
static const u8 sText_Static[] =                    _("{PKMN} ESTÀTICS");
static const u8 sText_SimiliarEvolutionLevel[] =    _("EQUILIBRAT");
static const u8 sText_InlcudeLegendaries[]=         _("LLEGENDARIS");
...
static const u8 sText_EvolutionMethods[] =          _("LÍNIES D'EVOL.");
...
static const u8 sText_SpeciesClause[]   = _("REGLA DUPLICATS");
static const u8 sText_ShinyClause[]     = _("REGLA BRILLANTS");
...
static const u8 sText_ExpMultiplier[]       = _("MULTIPL. D'EXP.");
static const u8 sText_Items_Player[]        = _("OBJ. DEL JUGADOR");
static const u8 sText_Items_Trainer[]       = _("OBJ. DELS ENTREN.");
static const u8 sText_NoEVs[]               = _("P.E. DEL JUGADOR");
static const u8 sText_ScalingIVs[]          = _("F.I. DELS ENTREN.");
static const u8 sText_ScalingEVs[]          = _("P.E. DELS ENTREN.");
//static const u8 sText_LimitDifficulty[]     = _("DIFICULTAT BLOQUEJADA");
//static const u8 sText_HardExp[]             = _("EXP. EN MODE DIFÍCIL");
static const u8 sText_MaxPartyIvs[]         = _("F.I. DEL JUGADOR");
static const u8 sText_DigRope[]             = _("CAVACL./CORDA F.");
...
static const u8 sText_Description_Mode_Gamemode_Classic[]         = _("Configuració recomanada.\n{COLOR 7}{COLOR 8}NOTA: Les seleccions són PERMANENTS.");
static const u8 sText_Description_Mode_Gamemode_Modern[]          = _("Tria les teues pròpies regles.\n{COLOR 7}{COLOR 8}NOTA: Les seleccions són PERMANENTS.");
static const u8 sText_Description_Mode_Gamemode_Custom[]          = _("Tria les teues pròpies regles.\n{COLOR 7}{COLOR 8}NOTA: Les seleccions són PERMANENTS.");
...
static const u8 sText_Description_Mode_Synchronize_Old[]          = _("SINCR. funciona com en la GEN. III.\n50% de probab. de copiar el caràcter.");
static const u8 sText_Description_Mode_Synchronize_New[]          = _("SINCR. funciona com en la GEN. VIII+.\n100% de probab. de copiar el caràcter.");
...
static const u8 sText_Description_Mode_Sturdy_On[]                = _("ROBUST funciona com en la GEN. V+. Els\n{PKMN} aguanten atacs letals amb 1 PS.");
static const u8 sText_Description_Mode_Modern_Moves_Off[]         = _("Cap ATAC nou i el JOC D'ATACS original\nper a tots, ATACS OU i TUTOR nous.");
static const u8 sText_Description_Mode_Modern_Moves_On[]          = _("13 ATACS nous, un JOC D'ATACS millorat\nper a tots, ATACS OU i TUTOR nous.");
static const u8 sText_Description_Mode_Leg_Abilities_Off[]        = _("PRESSIÓ es manté com a habilitat\nprincipal d'alguns llegendaris.");
static const u8 sText_Description_Mode_Leg_Abilities_On[]         = _("Els llegendaris canvien PRESSIÓ per\nuna habilitat millor.");
static const u8 sText_Description_Mode_New_Legendaries_Off[]      = _("No s'afegeixen llegendaris extres.");
static const u8 sText_Description_Mode_New_Legendaries_On[]       = _("S'afegeixen llegendaris de les GEN. I i II\nmitjançant esdeveniments interns.");
...
static const u8 sText_Description_Mode_Next[]                     = _("Continua a les opcions de\nfuncionalitat.");
...
static const u8 sText_Description_Features_ItemDrop_On[]              = _("Els {PKMN} salvatges deixaran caure el\nseu objecte en debilitar-los.");
static const u8 sText_Description_Features_ItemDrop_Off[]             = _("Només es podran obtindre els objectes\ndels {PKMN} si es capturen, o amb FURTAR.");
static const u8 sText_Description_Features_ShinyChance_8192[]         = _("Probab. molt baixa de trobar un {PKMN}\nBRILLANT. Igual que en la GEN. III.");
static const u8 sText_Description_Features_ShinyChance_4096[]         = _("Probab. baixa de trobar un {PKMN}\nBRILLANT. Igual que en les GEN. VI+.");
static const u8 sText_Description_Features_ShinyChance_2048[]         = _("Probab. decent de trobar un {PKMN}\nBRILLANT.");
static const u8 sText_Description_Features_ShinyChance_1024[]         = _("Probab. alta de trobar un {PKMN}\nBRILLANT.");
static const u8 sText_Description_Features_ShinyChance_512[]          = _("Probab. molt alta de trobar un {PKMN}\nBRILLANT.");
static const u8 sText_Description_Features_EasyFeebas_On[]            = _("SAMAREIG és més fàcil de capturar i\napareix arreu en la RUTA 119.");
...
static const u8 sText_Description_Features_FrontierBans_Unban[]       = _("Tots els llegendaris poden participar\nen el FRONT BATALLA.");
static const u8 sText_Description_Features_FrontierBans_Ban[]         = _("Els {PKMN} llegendaris més forts estan\nbandejats en el FRONT BATALLA.");
static const u8 sText_Description_Features_Shiny_Colors_Original[]    = _("Paleta de colors brillants original per\na tots els POKéMON. Predefinit.");
static const u8 sText_Description_Features_Shiny_Colors_Modern[]      = _("Alguns POKéMON brillants tenen\npaletes de color noves.");

static const u8 sText_Description_Features_Next[]                     = _("Continua a les opcions del\nMode Aleatori.");
...
static const u8 sText_Description_Random_WildPokemon_Off[]          = _("Els mateixos POKéMON salvatges\nque al joc original.");
...
static const u8 sText_Description_Random_Types_On[]                 = _("Aleatoritza els tipus dels POKéMON.");
static const u8 sText_Description_Random_Moves_Off[]                = _("Els atacs dels POKéMON són els\nmateixos que en el joc original.");
static const u8 sText_Description_Random_Moves_On[]                 = _("Aleatoritza els atacs dels POKéMON.");
static const u8 sText_Description_Random_Abilities_Off[]            = _("Les habilitats dels POKéMON són\nles mateixes que en el joc original.");
static const u8 sText_Description_Random_Abilities_On[]             = _("Aleatoritza les habilitats\ndels POKéMON.");
...
static const u8 sText_Description_Difficulty_ExpMultiplier_1_0[]        = _("Els POKéMON guanyen punts d'EXP.\nde manera normal.");
static const u8 sText_Description_Difficulty_ExpMultiplier_1_5[]        = _("Els POKéMON guanyen un 50 % més de\npunts d'EXPERIÈNCIA!");
static const u8 sText_Description_Difficulty_ExpMultiplier_2_0[]        = _("Els POKéMON guanyen el doble de punts\nd'EXPERIÈNCIA!");
static const u8 sText_Description_Difficulty_ExpMultiplier_0_0[]        = _("Els POKéMON guanyen {COLOR 7}{COLOR 8}ZERO punts d'EXP.!!!");
...
static const u8 sText_Description_Difficulty_ScalingIVs_Scaling[]       = _("Les F.I. dels POKéMON dels entrenadors\naugmenten amb cada medalla de gimnàs!");
static const u8 sText_Description_Difficulty_ScalingIVs_Hard[]          = _("Tots els POKéMON dels entrenadors\ntenen fortaleses innates perfectes!");
static const u8 sText_Description_Difficulty_ScalingEVs_Off[]           = _("Els POKéMON dels entrenadors no\ntenen punts d'esforç.");
static const u8 sText_Description_Difficulty_ScalingEVs_Scaling[]       = _("Els P.E. dels POKéMON dels entrenadors\naugmenten amb cada medalla de gimnàs!");
static const u8 sText_Description_Difficulty_ScalingEVs_Hard[]          = _("Tots els POKéMON dels entrenadors\ntenen punts d'esforç alts!");
static const u8 sText_Description_Difficulty_ScalingEVs_Extreme[]       = _("Tots els POKéMON dels entrenadors\ntenen {COLOR 7}{COLOR 8}252 P.E.! Molt difícil!");
static const u8 sText_Description_Difficulty_Next[]                     = _("Continua a les opcions dels reptes.");
static const u8 sText_Description_Challenges_LimitDifficulty_Off[]      = _("Canvia la dificultat quan i\non vullgues.");
static const u8 sText_Description_Challenges_LimitDifficulty_On[]       = _("La dificultat no es pot canviar. El\nMODE DIFÍCIL bloca l'ESTIL DE COMBAT a DEFINIT.");
static const u8 sText_Description_Difficulty_MaxPartyIvs_Off[]          = _("Els teus POKéMON tenen les fortaleses\ninnates habituals (entre 0 i 31).");
static const u8 sText_Description_Difficulty_MaxPartyIvs_On[]           = _("Els teus POKéMON sempre tenen les\nfortaleses innates al màxim (31).");
static const u8 sText_Description_Difficulty_MaxPartyIvs_On_HP[]        = _("Les F.I. s'estableixen entre 30 i 31\nper a permetre altres Poders Ocults.");
static const u8 sText_Description_Difficulty_LessEscapes_Off[]          = _("El jugador pot fugir amb facilitat\ndels combats, com sempre.");
static const u8 sText_Description_Difficulty_LessEscapes_On[]           = _("El jugador no pot fugir amb facilitat\ndels combats. Usa repelents!");
static const u8 sText_Description_Difficulty_EscapeRopeDig_Off[]        = _("No es pot gastar CORDA FUGIDA ni\nCAVACLOTS per a eixir de les coves.");
static const u8 sText_Description_Difficulty_EscapeRopeDig_On[]         = _("Es pot gastar CORDA FUGIDA i\nCAVACLOTS per a eixir de les coves.");
//static const u8 sText_Description_Difficulty_HardExp_Enabled[]          = _("Els {PKMN} guanyen un 60 % del total\nd'EXP. en DIFÍCIL. {COLOR 7}{COLOR 8}RECOMANAT.");
//static const u8 sText_Description_Difficulty_HardExp_Disabled[]         = _("Els {PKMN} guanyen l'EXP habitual en\nDIFÍFICL. {COLOR 7}{COLOR 8}NO RECOMANAT, massa fàcil.");
...
static const u8 sText_Description_Challenges_EvoLimit_First[]           = _("Els POKéMON només poden arribar a la\nprimera evolució.");
static const u8 sText_Description_Challenges_EvoLimit_All[]             = _("Els POKéMON {COLOR 7}{COLOR 8}NO PODEN evolucionar!");
static const u8 sText_Description_Challenges_OneTypeChallenge[]         = _("Permet que el jugador només puga\ncapturar i usar un tipus de POKéMON.");
static const u8 sText_Description_Challenges_BaseStatEqualizer_Base[]   = _("Els POKéMON tenen les estadístiques\nbase originals.");
static const u8 sText_Description_Challenges_BaseStatEqualizer_100[]    = _("Les estadístiques dels POKéMON es\ncalculen amb 100 de cada estad. base.");
static const u8 sText_Description_Challenges_BaseStatEqualizer_255[]    = _("Les estadístiques dels POKéMON es\ncalculen amb 255 de cada estad. base.");
static const u8 sText_Description_Challenges_BaseStatEqualizer_500[]    = _("Les estadístiques dels POKéMON es\ncalculen amb 500 de cada estad. base.");
static const u8 sText_Description_Challenges_Mirror_Off[]               = _("El jugador usa el seu propi equip.");
static const u8 sText_Description_Challenges_Mirror_Trainer[]           = _("Contra entrenadors, el jugador\nobté una còpia de l'equip rival!");
static const u8 sText_Description_Challenges_Mirror_All[]               = _("El jugador obté una còpia de l'equip\nrival en {COLOR 7}{COLOR 8}TOTS els combats!");
static const u8 sText_Description_Challenges_MirrorThief_Off[]          = _("El jugador recupera el seu equip\ndesprés del combat.");
static const u8 sText_Description_Challenges_MirrorThief_On[]           = _("El jugador es queda amb l'equip\ndel rival després del combat!");
static const u8 sText_Description_Challenges_Expensive_0ff[]            = _("Tot té un cost normal.");
static const u8 sText_Description_Challenges_Expensive_5[]              = _("Tot costa 5 vegades més!");
static const u8 sText_Description_Challenges_Expensive_10[]             = _("Tot costa 10 vegades més!\nClàssic capitalisme.");
static const u8 sText_Description_Challenges_Expensive_50[]             = _("Tot costa 50 vegades més!\nCapitalisme extrem!");
...
static const u8 sText_Challenges_Nuzlocke_Hardcore[]    = _("DIF.");
