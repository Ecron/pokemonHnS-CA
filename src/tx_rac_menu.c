...
static const u8 sText_NoEVs[]               = _("V.E. DEL JUGADOR");
static const u8 sText_ScalingIVs[]          = _("V.I. DELS ENTREN.");
static const u8 sText_ScalingEVs[]          = _("V.E. DELS ENTREN.");
//static const u8 sText_LimitDifficulty[]     = _("DIFICULTAT BLOQUEJADA");
//static const u8 sText_HardExp[]             = _("EXP. EN MODE DIFÍCIL");
static const u8 sText_MaxPartyIvs[]         = _("V.I. DEL JUGADOR");
