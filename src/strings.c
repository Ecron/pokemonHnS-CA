...
const u8 gText_ChoosePokemonCancel[] = _("Tria un POKéMON o CANCEĿLA.");
...
const u8 gText_Mailbox[] = _("BÚSTIA DE CORREU");
...
const u8 gText_FrameType[] = _("TIPUS");
...
const u8 gText_Confirm3[] = _("CONFIRMA");
