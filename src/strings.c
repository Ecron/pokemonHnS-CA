...
const u8 gText_ExpandedPlaceholder_Sapphire[] = _("SAFIR");
const u8 gText_ExpandedPlaceholder_Ruby[] = _("ROBÍ");
const u8 gText_ExpandedPlaceholder_Emerald[] = _("MARAGDA");
...
const u8 gText_ProfBirchMatchCallName[] = _("PROF. OLM");
...
const u8 gText_MainMenuMysteryEvents[] = _("ESDEV. MISTERIOSOS");
const u8 gText_WirelessNotConnected[] = _("L'adaptador sense cable no\nestà connectat.");
const u8 gText_MysteryGiftCantUse[] = _("El REGAL MISTERIÓS no es pot usar\nsi l'adaptador està connectat.");
const u8 gText_MysteryEventsCantUse[] = _("Els ESDEV. MISTERIOSOS no es poden usar\nsi l'adaptador està connectat.");
const u8 gText_UpdatingSaveExternalData[] = _("Actualitzant el fitxer de guardat\namb dades externes."); // Unused
const u8 gText_SaveFileUpdated[] = _("El fitxer de guardat s'ha actualitzat."); // Unused
const u8 gText_SaveFileCorrupted[] = _("El fitxer de guardat està danyat.\nEs carregarà la partida anterior.");
const u8 gText_SaveFileErased[] = _("S'ha esborrat el fitxer de guardat\nperquè estava danyat.");
const u8 gJPText_No1MSubCircuit[] = _("1Mサブきばんが ささっていません！");
const u8 gText_BatteryRunDry[] = _("La bateria interna s'ha esgotat.\nEl joc es pot jugar.\pPerò, els esdeveniments temporals\nno es produiran.\pSi no hi ha bateria, es recomana\ncomençar una altra partida amb RTC FALS.");
...
const u8 gText_ControlPad[] = _("+ Creu direccional"); // Unused
const u8 gText_LButtonRButton[] = _("Botó L  Botó R"); // Unused
const u8 gText_Controls[] = _("CONTROLS"); // Unused
ALIGNED(4) const u8 gText_PickOk[] = _("{DPAD_UPDOWN}TRIA {A_BUTTON}OK"); // Unused
ALIGNED(4) const u8 gText_Next[] = _("{A_BUTTON}SEGÜENT"); // Unused
ALIGNED(4) const u8 gText_NextBack[] = _("{A_BUTTON}SEGÜENT {B_BUTTON}ARRERE"); // Unused
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}TRIA {A_BUTTON}SEGÜENT {B_BUTTON}ARRERE");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}TRIA {A_BUTTON}{B_BUTTON}ARRERE");
ALIGNED(4) const u8 gText_AButtonExit[] = _("{A_BUTTON}IX");
const u8 gText_BirchBoy[] = _("XIC");
const u8 gText_BirchGirl[] = _("XICA");

const u8 gText_DefaultNameGold[] = _("SENTO");
const u8 gText_DefaultNameKris[] = _("CARMEN");
...
const u8 gText_ThisIsAPokemon[] = _("Açò és el que anomenem un “POKéMON”.{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? POKéMON");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????,? lb");
const u8 gText_EmptyPkmnCategory[] = _("                       POKéMON"); // Unused
const u8 gText_EmptyHeight[] = _("{CLEAR_TO 0x0C}    '    ”"); // Unused
const u8 gText_EmptyWeight[] = _("        ,   lb"); // Unused
const u8 gText_EmptyPokedexInfo1[] = _(""); // Unused
const u8 gText_CryOf[] = _("SO DE:");
const u8 gText_EmptyPokedexInfo2[] = _(""); // Unused
const u8 gText_SizeComparedTo[] = _("MIDA COMPARADA AMB ");
const u8 gText_PokedexRegistration[] = _("S'ha completat el registre de la POKéDEX.");
const u8 gText_HTHeight[] = _("HT");
const u8 gText_WTWeight[] = _("WT");
const u8 gText_SearchingPleaseWait[] = _("Buscant…\nEspera.");
const u8 gText_SearchCompleted[] = _("La recerca ha acabat.");
const u8 gText_NoMatchingPkmnWereFound[] = _("No s'ha trobat cap POKéMON coincident.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Busca POKéMON segons els\nparàmetres seleccionats.");
const u8 gText_SwitchPokedexListings[] = _("Canvia el llistat de la POKéDEX.");
const u8 gText_ReturnToPokedex[] = _("Torna a la POKéDEX.");
const u8 gText_SelectPokedexMode[] = _("Tria el mode de la POKéDEX.");
const u8 gText_SelectPokedexListingMode[] = _("Tria el mode de llistat de la POKéDEX.");
const u8 gText_ListByFirstLetter[] = _("Llista per la primera lletra del nom.\nNomés els POKéMON vists.");
const u8 gText_ListByBodyColor[] = _("Llista pel color del cos.\nNomés els POKéMON vists.");
const u8 gText_ListByType[] = _("Llista pel tipus.\nNomés els POKéMON capturats.");
const u8 gText_ExecuteSearchSwitch[] = _("Busca/canvia.");
const u8 gText_DexHoennTitle[] = _("POKéDEX DE JOHTO");
...
const u8 gText_DexSortHeaviestTitle[] = _("MODE PESAT");
const u8 gText_DexSortLightestTitle[] = _("MODE LLEUGER");
const u8 gText_DexSortTallestTitle[] = _("MODE ALT");
const u8 gText_DexSortSmallestTitle[] = _("MODE BAIX");
...
const u8 gText_DexHoennDescription[] = _("POKéDEX de la regió de JOHTO");
const u8 gText_DexNatDescription[] = _("POKéDEX edició nacional");
const u8 gText_DexSortNumericalDescription[] = _("Els POKéMON es llisten pel seu\nnúmero.");
const u8 gText_DexSortAtoZDescription[] = _("Els POKéMON vists i capturats es\nllisten en ordre alfabètic.");
...
const u8 gText_ConfirmStarterChoice[] = _("Tries este POKéMON?");
const u8 gText_Pokemon4[] = _("POKéMON"); // Unused
const u8 gText_FlyToWhere[] = _("A on vols VOLAR?");
const u8 gMenuText_Use[] = _("USA");
const u8 gMenuText_Toss[] = _("TIRA");
const u8 gMenuText_Register[] = _("ASSIGNA");
const u8 gMenuText_Give[] = _("DONA");
const u8 gMenuText_CheckTag[] = _("CHECK TAG");
const u8 gMenuText_Confirm[] = _("CONFIRMA");
const u8 gMenuText_Walk[] = _("WALK");
const u8 gText_Cancel[] = _("ARRERE");
const u8 gText_Cancel2[] = _("ARRERE");
const u8 gMenuText_Show[] = _("MOSTRA");
const u8 gText_EmptyString2[] = _("");
const u8 gText_Cancel7[] = _("ARRERE"); // Unused
const u8 gText_Item[] = _("OBJECTE");
const u8 gText_Mail[] = _("CORREU");
const u8 gText_Take[] = _("LLEVA");
...
const u8 gText_WhatWouldYouLike[] = _("Què t'agradaria fer?");
const u8 gMenuText_Give2[] = _("DONA");
const u8 gText_xVar1[] = _("×{STR_VAR_1}");
const u8 gText_Berry2[] = _(" BAIA"); // Unused
const u8 gText_Coins[] = _("{STR_VAR_1} MONEDES");
const u8 gText_CloseBag[] = _("TANCA");
const u8 gText_Var1IsSelected[] = _("Has triat \n{STR_VAR_1}.");
...
const u8 gText_DepositHowManyVar1[] = _("Quantes unitats\nhi vols guardar?");
const u8 gText_DepositedVar2Var1s[] = _("Guardes {STR_VAR_2} unitat(s)\nde {STR_VAR_1}.");
const u8 gText_NoRoomForItems[] = _("No hi ha espai per a\nemmagatzemar més objectes.");
const u8 gText_CantStoreImportantItems[] = _("Els obj. importants\nno es poden guardar\nen el PC!");
const u8 gText_TooImportantToToss[] = _("Això és mássa\nimportant com per\na tirar-ho!");
const u8 gText_TossHowManyVar1s[] = _("Quantes unitats\nvols tirar?");
const u8 gText_ThrewAwayVar2Var1s[] = _("Tires {STR_VAR_2} unitat(s)\nde {STR_VAR_1}.");
const u8 gText_ConfirmTossItems[] = _("Segur que vols\ntirar {STR_VAR_2} unitat(s)\nde {STR_VAR_1}?");
...
const u8 gText_TheField[] = _("a l'aventura");
const u8 gText_TheBattle[] = _("al combat");
const u8 gText_ThePokemonList[] = _("als POKéMON");
const u8 gText_TheShop[] = _("a la botiga");
...
const u8 gText_TMHMPocket[] = _("MT i MO");
const u8 gText_BerriesPocket[] = _("BAIES");
const u8 gText_KeyItemsPocket[] = _("IMPORTANTS");
...
const u8 gText_ShopSell[] = _("VEN");
const u8 gText_ShopQuit[] = _("ADEU!");
const u8 gText_SoldOut[] = _("Ho lamente, este objecte s'ha esgotat.\p");
const u8 gText_SoldOut2[] = _("ESGOTAT");
const u8 gText_InBagVar1[] = _("EN TENS: {STR_VAR_1}");
...
const u8 gText_Summary5[] = _("DADES");
const u8 gText_Moves[] = _("ATACS"); // Unused
...
const u8 gText_PkmnWasGivenItem[] = _("Equipes a {STR_VAR_1} amb\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyHoldingItemSwitch[] = _("{STR_VAR_1} ja porta una unitat\nde {STR_VAR_2}.\pVols intercanviar els\ndos objectes?");
const u8 gText_PkmnNotHolding[] = _("{STR_VAR_1} no té cap\nobjecte equipat.{PAUSE_UNTIL_PRESS}");
const u8 gText_ReceivedItemFromPkmn[] = _("Reps {STR_VAR_2}\nde {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_GiveToWhichPokemon[] = _("A quin POKéMON li ho dones?");
const u8 gText_DoWhatWithPokemon[] = _("Què vols fer amb el {PKMN}?");
...
const u8 gText_DoWhatWithItem[] = _("Què vols fer amb això?");
...
const u8 gText_ChoosePokemonCancel[] = _("Tria un POKéMON o ARRERE.");
...
const u8 gText_PutAway[] = _("ALÇA");
const u8 gText_Toss2[] = _("TIRA");
const u8 gText_Color161Shadow161[] = _("{COLOR 161}{SHADOW 161}");
const u8 gText_PutOutSelectedDecorItem[] = _("Col·loca decoracions a l'espai.");
const u8 gText_StoreChosenDecorInPC[] = _("Tria decoracions i guarda-les en el PC.");
const u8 gText_ThrowAwayUnwantedDecors[] = _("Tira les decoracions que no vullgues.");
const u8 gText_NoDecorations[] = _("No hi ha cap decoració.{PAUSE_UNTIL_PRESS}");
const u8 gText_Desk[] = _("TAULES");
const u8 gText_Chair[] = _("CADIRES");
const u8 gText_Plant[] = _("PLANTES");
const u8 gText_Ornament[] = _("ORNAMENTS");
const u8 gText_Mat[] = _("ESTORES");
const u8 gText_Poster[] = _("PÒSTERs");
const u8 gText_Doll[] = _("NINOTS");
const u8 gText_Cushion[] = _("COIXINS");
const u8 gText_Gold[] = _("OR");
const u8 gText_Silver[] = _("PLATA");
const u8 gText_PlaceItHere[] = _("Vols col·locar-ho ací?");
const u8 gText_CantBePlacedHere[] = _("No es pot col·locar ací.");
const u8 gText_CancelDecorating[] = _("Vols deixar de decorar?");
const u8 gText_InUseAlready[] = _("Ja ho estàs utilitzant.");
...
const u8 gText_NoDecorationsInUse[] = _("No hi ha cap decoració col·locada.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TurnOff[] = _("APAGA");
const u8 gText_Decoration[] = _("DECORACIÓ");
const u8 gText_ItemStorage[] = _("MAGATZEM");
const u8 gText_Mailbox[] = _("BÚSTIA");
const u8 gText_DepositItem[] = _("GUARDA OBJECTES");
const u8 gText_WithdrawItem[] = _("TRAU OBJECTES");
const u8 gText_TossItem[] = _("TIRA OBJECTES");
const u8 gText_StoreItemsInPC[] = _("Emmagatzema objectes en el PC.");
const u8 gText_TakeOutItemsFromPC[] = _("Trau objectes del PC.");
const u8 gText_ThrowAwayItemsInPC[] = _("Desfes-te d'objectes emmagatzemats en el PC.");
const u8 gText_NoItems[] = _("No hi ha cap objecte.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoRoomInBag[] = _("No tens espai\nen la MOTXILLA.");
const u8 gText_WithdrawHowManyItems[] = _("Quantes unitats\nen vols traure?");
const u8 gText_WithdrawXItems[] = _("Traus {STR_VAR_2} unitat(s)\nde {STR_VAR_1}.");
const u8 gText_Read[] = _("Llig");
const u8 gText_MoveToBag[] = _("MOU A LA MOTXILLA");
const u8 gText_Give2[] = _("DONA");
const u8 gText_NoMailHere[] = _("No hi ha cap CORREU.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MenuOptionPokenav[] = _("POKéFON");
const u8 gText_Blank[] = _("");
const u8 gText_MenuOptionSave[] = _("GUARDA");
const u8 gText_MenuOptionOption[] = _("OPCIONS");
const u8 gText_MenuOptionExit[] = _("IX");
...
const u8 gText_PkmnIsSelected[] = _("Has triat a {DYNAMIC 0}.");
...
const u8 gPCText_Cancel[] = _("ARRERE");
...
const u8 gText_CheckMapOfHoenn[] = _("Mira el mapa de la regió de JOHTO.");
const u8 gText_CheckPokemonInDetail[] = _("Check POKéMON in detail.");
const u8 gText_CallRegisteredTrainer[] = _("Toca a un ENTRENADOR registrat.");
const u8 gText_CheckObtainedRadio[] = _("Sintonitza la RÀDIO.");
const u8 gText_PutAwayPokenav[] = _("Apaga el POKéFON.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Torna al menú del POKéFON.");
...
const u8 gText_Call2[] = _("TOCA"); // Unused
const u8 gText_UnusedExit[] = _("IX"); // Unused
const u8 gText_CantCallOpponentHere[] = _("No se li pot tocar ací."); // Unused
...
const u8 gText_PokenavMap_ZoomedOutButtons[] = _("{A_BUTTON}APROPA {B_BUTTON}ARRERE");
extern const u8 gText_PokenavMap_CancelOnly[] = _("{B_BUTTON} Arrere");
const u8 gText_PokenavMap_ZoomedInButtons[] = _("{A_BUTTON}TOT {B_BUTTON}ARRERE");
...
const u8 gText_PokenavMatchCall_TrainerListButtons[] = _("{A_BUTTON}MENÚ {B_BUTTON}ARRERE");
const u8 gText_PokenavMatchCall_CallMenuButtons[] = _("{A_BUTTON}D'ACORD {B_BUTTON}ARRERE");
const u8 gText_PokenavMatchCall_CheckTrainerButtons[] = _("{B_BUTTON}ARRERE");
...
const u8 gText_PokenavRibbons_RibbonCheckButtons[] = _("{B_BUTTON}ARRERE");
...
const u8 gText_Call[] = _("TOCA-LI");
const u8 gText_Check[] = _("CHECK");
const u8 gText_Cancel6[] = _("ARRERE");
...
const u8 gText_TrainerCardTime[] = _("TEMPS DE JOC");
const u8 gJPText_BattlePoints[] = _("ゲ-ムポイント"); // Unused. Name presumed, translation is Game Points
const u8 gText_Var1sTrainerCard[] = _("CARNET D'ENTRENADOR DE: {STR_VAR_1}");
const u8 gText_HallOfFameDebut[] = _("DEBUT SALA D'HONOR  ");
...
const u8 gText_Easy[] = _("FÀCIL");
const u8 gText_Hard[] = _("DIFÍCIL");
const u8 gText_Modern[] = _("MODERN");
const u8 gText_Classic[] = _("CLÀSSIC");
//HnS texts
const u8 gText_Sunday[] = _("DIUMENGE");
const u8 gText_Monday[] = _("DILLUNS");
const u8 gText_Tuesday[] = _("DIMARTS");
const u8 gText_Wednesday[] = _("DIMECRES");
const u8 gText_Thursday[] = _("DIJOUS");
const u8 gText_Friday[] = _("DIVENDRES");
const u8 gText_Saturday[] = _("DISSABTE");
...
const u8 gText_Option[] = _("OPCIÓ");
const u8 gText_TextSpeed[] = _("VEL. DEL TEXT");
const u8 gText_BattleScene[] = _("ANIM. AL COMBAT");
const u8 gText_BattleStyle[] = _("ESTIL DE COMBAT");
const u8 gText_Autorun[] = _("CARRERA");
const u8 gText_Sound[] = _("SO");
const u8 gText_Frame[] = _("MARC");
const u8 gText_OptionMenuCancel[] = _("ARRERE");
const u8 gText_FollowerEnable[] = _("{PKMN} SEGUIDOR");  //tx_optionsPlus
const u8 gText_AutorunEnable[] = _("CARRERA");  //tx_optionsPlus
const u8 gText_OptionMatchCalls[] = _("TELEFONADES");  //tx_optionsPlus
const u8 gText_OptionMenuSave[] = _("GUARDAR");  //tx_optionsPlus
const u8 gText_OptionStyle[] = _("TIPUS D'ATACS");  //tx_optionsPlus
const u8 gText_OptionDifficulty[] = _("DIFICULTAT");  //tx_optionsPlus
const u8 gText_ButtonMode[] = _("MODE DELS BOTONS");
const u8 gText_TextSpeedSlow[] = _("LENTA");
const u8 gText_TextSpeedMid[] = _("MITJ.");
const u8 gText_TextSpeedFast[] = _("RÀP.");
const u8 gText_BattleSceneOn[] = _("SÍ");
const u8 gText_BattleSceneOff[] = _("NO");
const u8 gText_BattleStyleShift[] = _("CANVI");
const u8 gText_BattleStyleSet[] = _("FIX");
const u8 gText_SoundMono[] = _("MONO");
const u8 gText_SoundStereo[] = _("ESTÈREO");
const u8 gText_FrameType[] = _("ESTIL");
...
const u8 gText_AutorunOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NO"); //OLD
const u8 gText_AutorunOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SÍ"); //OLD
const u8 gText_NumPlayerLink[] = _("{STR_VAR_1}P LINK");
const u8 gText_BronzeCard[] = _("BRONZE");
const u8 gText_CopperCard[] = _("COBRE");
const u8 gText_SilverCard[] = _("PLATA");
const u8 gText_GoldCard[] = _("DAURADA");
const u8 gText_Day[] = _("DIA");
const u8 gText_Colon3[] = _(":");
const u8 gText_Confirm2[] = _("CONFIRMA");
const u8 gText_Days[] = _("Dies"); // Unused
const u8 gText_TimeColon2[] = _("Hora:"); // Unused
const u8 gText_GameTime[] = _("Hora del joc"); // Unused
const u8 gText_RTCTime[] = _("Hora RTR"); // Unused
...
const u8 gText_MenuPokenav[] = _("POKéFON");
const u8 gText_MenuPlayer[] = _("{PLAYER}");
const u8 gText_MenuSave[] = _("GUARDA");
const u8 gText_MenuOption[] = _("OPCIONS");
const u8 gText_MenuExit[] = _("IX");
...
const u8 gText_CallCantBeMadeHere[] = _("El telèfon no funciona ací.");
...
const u8 gText_IsThisTheCorrectTime[] = _("És esta l'hora correcta?");
const u8 gText_Confirm3[] = _("D'ACORD");
const u8 gText_Cancel4[] = _("ARRERE");
const u8 gText_MrStoneMatchCallDesc[] = _("DEVON PRES");
const u8 gText_MrStoneMatchCallName[] = _("MR. STONE");
const u8 gText_StevenMatchCallDesc[] = _("SÚPER DUR");
const u8 gText_StevenMatchCallName[] = _("STEVEN");
const u8 gText_MayBrendanMatchCallDesc[] = _("VEÍ GUAI");
const u8 gText_NormanMatchCallDesc[] = _("EL REFERENT");
const u8 gText_MomMatchCallDesc[] = _("BONICOR");
const u8 gText_BaobaMatchCallDesc[] = _("VIGILANT SAFARI");
const u8 gText_WallyMatchCallDesc[] = _("FAN {PKMN}");
const u8 gText_NormanMatchCallName[] = _("PARE");
const u8 gText_MomMatchCallName[] = _("MARE");
const u8 gText_BaobaMatchCallName[] = _("BAOBA");
const u8 gText_ScottMatchCallDesc[] = _("ULLS ELUSIUS");
...
const u8 gText_WinonaMatchCallDesc[] = _("AMA DELS CELS");
const u8 gText_TateLizaMatchCallDesc[] = _("DUO MÍSTIC");
const u8 gText_JuanMatchCallDesc[] = _("SEDUCTOR");
const u8 gText_EliteFourMatchCallDesc[] = _("JUNTA D'ELIT");
